...
<%--     <link rel="stylesheet" href="${ contextPath }/resources/css/common/navbar.css"> --%>
    ...
    <link rel="stylesheet" href="${ contextPath }/resources/css/mypage/jw2.css">
...
<%-- 			<li><a onclick="javascript:location.href='${contextPath}/mypage/admin/insertAgency' 'target=_blank'">소속사등록</a></li> --%>
			<li id="insertAgency"><a class="third after">소속사등록</a></li>
			<li><a class="third after" onclick="javascript:location.href='${contextPath}/mypage/admin/report'">신고관리</a></li>
			<li><a class="third after" onclick="javascript:location.href='${contextPath}/notice/list'">공지사항</a></li>
			<li><a class="third after" onclick="javascript:location.href='${contextPath}/mypage/admin/management'">회원관리</a></li>
			<li><a class="third after" onclick="javascript:location.href='${contextPath}/mypage/admin/paylist'">결제내역</a></li>
