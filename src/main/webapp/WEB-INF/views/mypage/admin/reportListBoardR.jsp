	...
	<section id="mypageAdminSection">
        ...
        <article id="mypageContent">
            ...
            <div id="mypageContentListDiv">
                ...
                /
                <a class="mypageContentCategory"
                href="${contextPath}/mypage/admin/report/feedReply" style="font-weight: 700;">피드,아티스트 댓글</a>
            </div>
...
<%--링크도 추가하기 --%>
                		 >
                			...
                			<td>${ r.boardr.id }</td>			<!-- 피의자 -->
                			<td>${ r.boardr.brcontent }</td>		<!-- 신고 게시물 정보 -->
...
<%--                 				<a onclick="${contextPath}/"> --%>
                			...
                			<input type="hidden" value="B_RE_RPT" style="display:none;">	<!-- 11 쓰지않는거 넘기기-->
                		</tr>
                	</c:forEach>
